...
<body id="body">
    <div id="app">
                    ...
                    @elseif(Auth::user()->admin == 0)
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <!--<li><a href="{{ url('/auth/user/manage') }}">Manage Account</a></li>-->
        ...
        <!-- Blog Sidebar Widgets Column -->
            <div class="col-md-4">
                <!-- ADD POST -->
                <a class="btn btn-danger btn-sm" href="{{ url('/auth/post/create') }}">Post Question <span class="glyphicon glyphicon-chevron-right"></span></a>
                <br />
                 <!--Blog Purpose Well-->
                <br />
                <div class="well" id="well">
                    <h4>SITE PURPOSE</h4>
                    <p>Have a question you don't feel confortable asking anyone? Ask it here and get answers from other users. Nobody will ever know who you are.</p>
                </div>

                
                <!-- Blog Categories Well -->
                <div class="well" id="well" style="text-decoration: none;">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="list-unstyled">
                                @foreach ($viewRecentPosts as $p)
                                <hr>
                                <li><a href="/post/{{$p->id}}">{{$p->subject}}</a></li>
                                @endforeach
                            </ul>
                        </div>
